...
"..\Source Code\bin\GeoGen\bin\geogen.exe" -s %ran% -i "..\Map Templates\Phantom Islands.nut" -a -n -o "%mpName%" -d "%dirName%" 257 2 0

md "..\Output\FA Maps\CGM-%ran%"
set outF=..\Output\FA Maps\CGM-%ran%\CGM-%ran%.scmap

"..\Source Code\bin\MapGenerator\Map Generator.exe" "%dirName%" 256 256 "%outF%" "..\Tilesets\TilesetData-8.xml" %ran%