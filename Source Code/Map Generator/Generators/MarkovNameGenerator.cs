...
// * Copyright Unknown
// * Filename: MarkovNameGenerator.cs
// * Source: http://http://www.siliconcommandergames.com/MarkovNameGenerator.htm
// ***************************************************************************************
...
{
    //constructor
    public MarkovNameGenerator(IEnumerable<string> sampleNames, int order, int minLength, Random r)
    {
        _rnd = r;
        ...
        {
            for (int letter = 0; letter <= word.Length - order - 1; letter++)
            {
