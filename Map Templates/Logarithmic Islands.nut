...
function Generate(){
	...
	local islandSize = (GGen_GetArgValue("island_size") + 1) *  12 + 32;
	...
	for(local i = 4*PI/2; i < 8*PI/2; i=i+PI/5 / (i/5))
	{
		
		local x1 = (1 * pow(1*i, 2.7182818284590) * cos(i)).tointeger() + mapSize/2;
		local y1 = (1 * pow(1*i, 2.7182818284590) * sin(i)).tointeger() + mapSize/2;
		...
		if(x1 >= 0 && x1 < mapSize && y1 >= 0 && y1 < mapSize)
		{
			...
			local o2 = PI / 2;
			local x2 = (1 * pow(1*i, 2.7182818284590) * cos(i+o2)).tointeger() + mapSize/2;
			local y2 = (1 * pow(1*i, 2.7182818284590) * sin(i+o2)).tointeger() + mapSize/2;
			base.UnionTo(islandTile, x2 - islandTile.GetWidth()/2, y2 - islandTile.GetHeight()/2);
			
			local o3 = PI;
			local x3 = (1 * pow(1*i, 2.7182818284590) * cos(i+o3)).tointeger() + mapSize/2;
			local y3 = (1 * pow(1*i, 2.7182818284590) * sin(i+o3)).tointeger() + mapSize/2;
			base.UnionTo(islandTile, x3 - islandTile.GetWidth()/2, y3 - islandTile.GetHeight()/2);
			
			local o4 = 3*PI/2;
			local x4 = (1 * pow(1*i, 2.7182818284590) * cos(i+o4)).tointeger() + mapSize/2;
			local y4 = (1 * pow(1*i, 2.7182818284590) * sin(i+o4)).tointeger() + mapSize/2;
			base.UnionTo(islandTile, x4 - islandTile.GetWidth()/2, y4 - islandTile.GetHeight()/2);
		}
